...
//    }
    ...
    public void FormulaList(View view) {
        //currentSinglePlayer = new Pokhri();
        SetFragment();
    }
    ...
    public void SetFragment() {
        getSupportFragmentManager()
                .beginTransaction()
                .replace(R.id.content_frame, FormulaList.newInstance(allFormulaList), "FormulaList")
